    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          >
            {ticket.event.is_cancelled
              ? "For questions about refunds or cancellations, please contact our support team at team@aenulfahir-tickr.com"
              : "If you have any issues with your ticket, please contact our support team at team@aenulfahir-tickr.com"}
          </p>
        </div>
      </div>
    </div>
