                ...
                <FormControl>
                  <div className="relative">
                    <Input
                      ...
                      className="border rounded-lg p-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-500" // Styling for the input
                    />
                  </div>
                </FormControl>
                <FormMessage />
                ...
                <FormControl>
                  <div className="flex items-center">
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        // Remove dots and convert to number, then set field value
                        const value = e.target.value.replace(/\./g, "");
                        field.onChange(value ? Number(value) : null); // Handle empty input
                      }}
                      className="pl-2"
                    />
                  </div>
