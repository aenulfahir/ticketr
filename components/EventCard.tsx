      ...
      <div className={`p-6 ${imageUrl ? "relative" : ""}`}>
        <div className="flex justify-between items-start">
          ...
          <div>
            ...
            {isPastEvent && (
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium text-gray-800 mt-2">
                Past Event
              </span>
            )}
          </div>
          ...
          <div className="flex flex-col items-end gap-2 ml-4">
            ...
            >
              {new Intl.NumberFormat("id-ID", {
                style: "currency",
                currency: "IDR",
                minimumFractionDigits: 0, // You can adjust this if you want to show decimals
              }).format(event.price)}
            </span>
